...
class MyGameFilter extends StatefulWidget {
  const MyGameFilter({super.key});

  @override
  State<MyGameFilter> createState() => _MyGameFilterState();
}

class _MyGameFilterState extends State<MyGameFilter> {
